...
export class SchemaSync1613480583258 implements MigrationInterface {
    name = 'SchemaSync1613480583258'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "coffee" ADD "reccomendations" integer NOT NULL DEFAULT '0'`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "coffee" DROP COLUMN "reccomendations"`);
